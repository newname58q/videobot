...
async def entergroup(client, message):
    ...
    try:
        ...
        await message.reply_text(
            "<b>💡 ʙᴜɴᴜ ʏᴀᴘᴀʙɪʟᴍᴇᴍ ɪçɪɴ ʙᴇɴɪᴍ ᴛüᴍ ʏᴇᴛᴋɪʟᴇʀɪᴍɪ ᴀçıɴ !</b>",
        )
        return
    ...
    try:
        ...
        await USER.send_message(message.chat.id, "🤖: ꜱᴇɴ Çᴀɢıʀıʀꜱıɴ ᴅᴀ ɢᴇʟᴍᴇᴢᴍɪʏɪᴍ ᴇᴍʀɪɴᴅᴇʏɪᴍ 😎 ")
    except UserAlreadyParticipant:
        await message.reply_text(
            "<b>✅ ᴀꜱɪꜱᴛᴀɴ ᴢᴀᴛᴇɴ ʙᴜ ɢʀᴜʙᴀ ɢɪʀᴅɪ</b>",
        )
